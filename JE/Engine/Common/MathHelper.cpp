...
{
	return XMFLOAT3(val1.x + val2.x, val1.y + val2.y, val1.z + val2.z);
}
...
{
	return XMFLOAT3(val1 * val2.x, val1 * val2.y, val1 * val2.z);
}

XMFLOAT3 operator* (const XMFLOAT3& val1, const FLOAT& val2)
{
	return XMFLOAT3(val2 * val1.x, val2 * val1.y, val2 * val1.z);
}

XMFLOAT3 operator/ (const XMFLOAT3& val1, const FLOAT& val2)
{
	return XMFLOAT3(val1.x / val2, val1.y / val2, val1.z / val2);
}