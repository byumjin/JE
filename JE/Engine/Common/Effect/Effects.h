...
public:
	...
	void SetTexture(ID3D11ShaderResourceView* Texture, ID3DX11EffectShaderResourceVariable* pTexture)		{ pTexture->SetResource(Texture); }
...
public:
	...
	virtual void SetNulltoTextures()
	{
		...
		SetTexture(NULL, mSelectedTexture);
	...
	ID3DX11EffectShaderResourceVariable* mSelectedTexture;
