...
bool DebugWindow::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, int resolutionWidth, int resolutionHeight)	
{
	bool result;
...
void DebugWindow::OnResize(int ScreenWidth, int ScreenHeight, int MapWidth, int MapHeight)
{
...
bool DebugWindow::Render(ID3D11DeviceContext* deviceContext, int positionX, int positionY, XMFLOAT4X4 InvViewProj, ID3DX11EffectTechnique* pTech, Effects* pEffects)
{
	bool result;
	...
	if(pEffects != NULL)
		RenderBuffers(deviceContext,  pTech,  pEffects->DebugWindowFx);
	else
		RenderBuffers(deviceContext, pTech, NULL);
	return true;
}
...
XMFLOAT4 DebugWindow::CalculateVertex(float X, float Y, XMFLOAT4X4 InvViewProj)
{
...
bool DebugWindow::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY, XMFLOAT4X4 InvViewProj)
{
...
void DebugWindow::RenderBuffers(ID3D11DeviceContext* deviceContext, ID3DX11EffectTechnique* pTech, Effect* pEffect)
{
	unsigned int stride;
	unsigned int offset;
